...
public class Toaster {
    ...
    private static void show(@Nullable final Activity activity, final int resId,
                             final int duration) {
        if (activity == null)
            return;
    ...
    private static void show(@Nullable final Activity activity, final String message,
                             final int duration) {
        if (activity == null)
            return;
    ...
    public static void showLong(final Activity activity, @NonNull final String message,
                                final Object... args) {
        String formatted = MessageFormat.format(message, args);
        show(activity, formatted, LENGTH_LONG);
    }

    public static void showShort(final Activity activity, @NonNull final String message,
                                 final Object... args) {
        String formatted = MessageFormat.format(message, args);
        show(activity, formatted, LENGTH_SHORT);
    }

    public static void showLong(@Nullable final Activity activity, final int resId,
                                final Object... args) {
        if (activity == null)
            return;
    ...
    public static void showShort(@Nullable final Activity activity, final int resId,
                                 final Object... args) {
        if (activity == null)
            return;
