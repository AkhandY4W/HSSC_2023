...
public class PreferencesManager {
    ...
    @Nullable
    public String getid() {
        return mPreferences.getString(PreferencesManager.Keys.USERID, null);
    }


    public void setid(String userJson) {
        mEditor.putString(PreferencesManager.Keys.USERID, userJson).apply();
    }
