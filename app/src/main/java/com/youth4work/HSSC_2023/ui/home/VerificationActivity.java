...
import com.youth4work.HSSC_2023.ui.startup.AllWebView;
...
public class VerificationActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtwebverify.setOnClickListener(v ->
                AllWebView.LoadWebView(VerificationActivity.this, "https://www.youth4work.com/User/EditProfile","EditProfile"));
        ...
        btnGotEmailCode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
    ...
    private void CheckNoRegister() {
        ...
        String mobile = etMobile.getText().toString().trim().replace("+91", "");
