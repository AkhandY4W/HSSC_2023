package com.youth4work.HSSC_2023.ui.payment;
...
import com.youth4work.HSSC_2023.PayTM.PaytmCancel;
import com.youth4work.HSSC_2023.PayTM.PaytmCancelTransaction;
import com.youth4work.HSSC_2023.PayTM.PaytmMerchant;
import com.youth4work.HSSC_2023.PayTM.PaytmOrder;
import com.youth4work.HSSC_2023.PayTM.PaytmPGService;
import com.youth4work.HSSC_2023.PayTM.PaytmPaymentTransactionCallback;
import com.youth4work.HSSC_2023.PayTM.PaytmStatusQuery;
import com.youth4work.HSSC_2023.PayTM.PaytmStatusQueryCallback;
import com.youth4work.HSSC_2023.PrepApplication;
...
import com.youth4work.HSSC_2023.ui.base.BaseActivity;
import com.youth4work.HSSC_2023.ui.home.DashboardActivity;
...
public class PlanReviewActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGooglePay.setOnClickListener(v -> {
            ...
            if(isAppInstalled)
                payUsingUpi(String.valueOf(mPlan.getDisAmount()), "y4w@kotak", "Youth4work", mPlan.getServiceName());
            else{
                Toast.makeText(PlanReviewActivity.this, "App is not installed", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void updatePlan(int serviceid, String ccode, int amt) {
        ...
        prepService.doUpgradeOn100pDis(userUpgrade).enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                mUserManager.getUser().setPlanEndDate(String.valueOf(calendar.getTimeInMillis()));
    ...
    public void onStartTransaction(View view) {
        if (mPlan.getDisAmount() == 0) {
            ...
            paramMap.put("CALLBACK_URL", "https://admin.youth4work.com/paytm/VerifyChecksum.aspx");
            PaytmOrder Order = new PaytmOrder(paramMap);
            PaytmMerchant Merchant = new PaytmMerchant(
                    "https://admin.youth4work.com/paytm/GenerateChecksum.aspx",
                    "https://admin.youth4work.com/paytm/VerifyChecksum.aspx");
            ...
            Service.startPaymentTransaction(this, true, true,
                    new PaytmPaymentTransactionCallback() {
                        ...
                        public void onTransactionFailure(String inErrorMessage,
                            ...
                            PaymentStatusActivity.show(PlanReviewActivity.this, false, "Error:" + inErrorMessage + " for order " + paramMap.get("ORDER_ID"), mPlan.getServiceID(), true, new Double(inResponse.getString("TXNAMOUNT")).intValue(), mPlan.getValidity(),couponCode,String.valueOf(taxAmount),String.valueOf(mPlan.getAmount()));
