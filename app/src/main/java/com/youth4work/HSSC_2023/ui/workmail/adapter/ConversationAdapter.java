package com.youth4work.HSSC_2023.ui.workmail.adapter;
...
public class ConversationAdapter extends RecyclerView.Adapter<ConversationAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        Picasso.with(mContext).load(mUser.getImgUrl()).placeholder(R.drawable.ic_user_default).into(holder.userImage);
