package com.youth4work.HSSC_2023.ui.forum;
...
import com.youth4work.HSSC_2023.network.model.Answers;
import com.youth4work.HSSC_2023.network.model.ForumDetails;
import com.youth4work.HSSC_2023.ui.adapter.AnswersItem;
...
public class PrepForumDetails extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        prepService = PrepApi.createService(PrepService.class, PreferencesManager.instance(PrepForumDetails.this).getToken());
        ...
        prepService.prepForumDetails(forumid, mUserManager.getUser().getUserId()).enqueue(new Callback<ForumDetails>() {
            ...
            public void onResponse(Call<ForumDetails> call, @NonNull Response<ForumDetails> response) {
                ...
                if (mprepForumDetails.ForumId > 0) {
                    ...
                    Picasso.with(PrepForumDetails.this).load(mprepForumDetails.CreatedByPic).into(imageView);
