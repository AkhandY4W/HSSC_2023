...
import com.youth4work.HSSC_2023.ui.adapter.CouponAdapter;
...
public class ApplyCouponActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextcouponcode = (EditText) findViewById(R.id.editTextcouponcode);
        listCoupon = (RecyclerView) findViewById(R.id.list_coupon);
    ...
    private void setuplistcopuon() {
        ...
        /*mcouponAdapter.setOnItemClickListener((itemView, position) -> {
            Intent intent=new Intent(ApplyCouponActivity.this,UpgradePlanActivity.class);
            startActivity(intent);
        });*/
    }
