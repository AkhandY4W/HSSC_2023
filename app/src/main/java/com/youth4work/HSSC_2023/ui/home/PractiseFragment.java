...
import com.youth4work.HSSC_2023.ui.adapter.SectionItem;
import com.youth4work.HSSC_2023.ui.base.BaseFragment;
import com.youth4work.HSSC_2023.ui.quiz.SectionTestActivity;
import com.youth4work.HSSC_2023.ui.quiz.TestRulesActivity;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mUserManager.getCategory()!=null) {
            ...
            if(mUserManager.getCategory().getSubCategoryImg()!=null && !mUserManager.getCategory().getSubCategoryImg().equals(""))
                Picasso.with(self).load(mUserManager.getCategory().getSubCategoryImg()).into(imgCat);
        ...
        if (subjectsRecyclerView != null) {
            ...
            if(mSubjectList.size()>=1) {
                ...
                sectionAdapter.setOnItemClickListener((itemView, position) ->
                {
                    ...
                    SectionTestActivity.show(self, mSubjectList.get(position));
                });
            }
