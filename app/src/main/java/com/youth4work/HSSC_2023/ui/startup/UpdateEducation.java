...
import com.youth4work.HSSC_2023.network.model.AutoCompleteData;
...
public class UpdateEducation extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etCollege = (MaterialAutoCompleteTextView) findViewById(R.id.et_college);
        etDegree = (MaterialAutoCompleteTextView) findViewById(R.id.et_degree);
        etSpecialization = (MaterialAutoCompleteTextView) findViewById(R.id.et_specialization);
        etBatchTo = (MaterialEditText) findViewById(R.id.et_batch_to);
        etBatchFrom = (MaterialEditText) findViewById(R.id.et_batch_from);
        progressActivity = (ProgressRelativeLayout) findViewById(R.id.activity_sign_up3);
    ...
    public void setcurrenteducationdat() {
        if (educationDetails != null && educationDetails.getEducationid() > 0) {
            ...
            etBatchFrom.setText("Jan" + "," + String.valueOf(startYear));
            etBatchTo.setText("Jan" + "," + String.valueOf(endYear));
