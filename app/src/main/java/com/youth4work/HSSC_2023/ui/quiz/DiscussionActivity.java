...
import com.youth4work.HSSC_2023.ui.adapter.DiscussionItem;
...
public class DiscussionActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(qs.getQuestionImgUrl()!=null&&!qs.getQuestionImgUrl().equals("")){
            ...
            Picasso.with(DiscussionActivity.this).load(qs.getQuestionImgUrl()).into(queImage);
        }
        if(qs.getOptions().get(0).getOptionImgUrl()!=null&&!qs.getOptions().get(0).getOptionImgUrl().equals("")){
            ...
            Picasso.with(DiscussionActivity.this).load(qs.getOptions().get(0).getOptionImgUrl()).into(ansImage);
        }
