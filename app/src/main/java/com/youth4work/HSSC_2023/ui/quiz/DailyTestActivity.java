...
import static com.youth4work.HSSC_2023.util.PrepDialogsUtilsKt.showFreeTrailExpiredDialog;
import static com.youth4work.HSSC_2023.util.PrepDialogsUtilsKt.showQuestionBankOverDialog;
import static com.youth4work.HSSC_2023.util.PrepDialogsUtilsKt.showQuitTestDialog;
import static com.youth4work.HSSC_2023.util.PrepDialogsUtilsKt.showUpgradeDialog;
...
public class DailyTestActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDisc.setOnClickListener(v -> OnDiscussionClicked());
    }
    ...
    private void initButtonUI() {
        switch (state) {
            case INITIAL:
                ...
                ViewUtils.setGone(btnDisc, true);
            ...
            case TIME_UP:
                ...
                ViewUtils.setGone(btnDisc, false);
