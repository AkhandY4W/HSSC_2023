...
import com.youth4work.HSSC_2023.ui.adapter.CommentsAnswersItem;
...
public class CommentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            Picasso.with(CommentsActivity.this).load(commenterImage).into(imageAnswer);
        ...
        prepService = PrepApi.createService(PrepService.class, PreferencesManager.instance(CommentsActivity.this).getToken());
