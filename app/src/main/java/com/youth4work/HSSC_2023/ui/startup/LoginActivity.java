package com.youth4work.HSSC_2023.ui.startup;
...
import com.youth4work.HSSC_2023.infrastructure.UserManager;
...
import com.youth4work.HSSC_2023.ui.home.CategoryExamsActivity;
import com.youth4work.HSSC_2023.ui.home.DashboardActivity;
import com.youth4work.HSSC_2023.ui.views.PrepButton;
import com.youth4work.HSSC_2023.util.Constants;
import com.youth4work.HSSC_2023.util.Keyboard;
import com.youth4work.HSSC_2023.util.PreferencesManager;
import com.youth4work.HSSC_2023.util.Toaster;
                ...
                public void onResponse(Call<User> call, @NonNull Response<User> response) {
                    if (response.isSuccessful() && response.body().getName() != null) {
                        ...
                        if (mUserManager.getUser().getSelectedCatID() == 0) {
                            ...
                            startActivity(new Intent(LoginActivity.this, CategoryExamsActivity.class));
                        } else {
                            ...
                            progressActivity.showContent();
                            if (!hasSelected) {
                                mUserManager.getUser().setSelectedCatID(0);
                                Intent intent = new Intent(LoginActivity.this, CategoryExamsActivity.class);
                                startActivity(intent);
                            } else {
