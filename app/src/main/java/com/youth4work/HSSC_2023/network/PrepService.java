package com.youth4work.HSSC_2023.network;

import androidx.annotation.NonNull;

import com.youth4work.HSSC_2023.network.model.AllMockQSModel;
import com.youth4work.HSSC_2023.network.model.Attempt;
import com.youth4work.HSSC_2023.network.model.Category;
import com.youth4work.HSSC_2023.network.model.Comments;
import com.youth4work.HSSC_2023.network.model.CommentsAnswersData;
import com.youth4work.HSSC_2023.network.model.CouponCode;
import com.youth4work.HSSC_2023.network.model.EducationDetails;
import com.youth4work.HSSC_2023.network.model.ForumDetails;
import com.youth4work.HSSC_2023.network.model.Plan;
import com.youth4work.HSSC_2023.network.model.PrepForum;
import com.youth4work.HSSC_2023.network.model.Question;
import com.youth4work.HSSC_2023.network.model.Rank;
import com.youth4work.HSSC_2023.network.model.Section;
import com.youth4work.HSSC_2023.network.model.Subject;
import com.youth4work.HSSC_2023.network.model.SubjectStats;
import com.youth4work.HSSC_2023.network.model.TestResult;
import com.youth4work.HSSC_2023.network.model.User;
import com.youth4work.HSSC_2023.network.model.UserStats;
import com.youth4work.HSSC_2023.network.model.request.CommentOnForumAnswerRequest;
import com.youth4work.HSSC_2023.network.model.request.CommentRequest;
import com.youth4work.HSSC_2023.network.model.request.ForumAnswerEditRequest;
import com.youth4work.HSSC_2023.network.model.request.ForumAnswerRequest;
import com.youth4work.HSSC_2023.network.model.request.ForumRequest;
import com.youth4work.HSSC_2023.network.model.request.GcmRegister;
import com.youth4work.HSSC_2023.network.model.request.LoginRequest;
import com.youth4work.HSSC_2023.network.model.request.PostVote;
import com.youth4work.HSSC_2023.network.model.request.PushAnswer;
import com.youth4work.HSSC_2023.network.model.request.UserRegister;
import com.youth4work.HSSC_2023.network.model.request.UserRegisterSocial;
import com.youth4work.HSSC_2023.network.model.request.UserUpgrade;
import com.youth4work.HSSC_2023.network.model.response.LoginResponse;
import com.youth4work.HSSC_2023.network.model.response.UserAllow;
import com.youth4work.HSSC_2023.network.model.response.VoteResponse;
...
public interface PrepService {
    ...
    @NonNull
    @GET("rankBySubject")
    Call<List<Rank>> ranksByCategory(@Query("SubjectId") int categoryId, @Query("pageNumber") int pageNo, @Query("pageSize") int pageSize);
    ...
    @NonNull
    @GET("getSubjectStats")
    Observable<List<SubjectStats>> subjectStats(@Query("Userid") long userId, @Query("SubCatID") int catId);
